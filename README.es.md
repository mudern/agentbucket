...
<p align="center">Plano de control de agentes AI para agentes definidos por repositorio, despliegues Docker, orquestación sidecar y operaciones API-first.</p>
...
AgentBucket escanea definiciones de agentes desde repositorios Git, empaqueta agentes seleccionados con skills estándar y configuraciones MCP en imágenes Docker, ejecuta un sidecar en cada contenedor y expone una UI web y APIs curl-friendly para despliegue, chat, resolución de tokens y mensajería entre agentes.
...
Ver [README.md](README.md) para documentación completa en inglés.
